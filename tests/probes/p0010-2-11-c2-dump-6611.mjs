// Dump module 6611 (store lib) factory source to find the window flag names.
...
const r = await send('Runtime.evaluate',{expression:`String(window.__wr.m[6611])`,returnByValue:true});
writeFileSync('/Users/bx/Workspace/agentFabric/data/bundles/module-6611.js', r.result.value||'');
