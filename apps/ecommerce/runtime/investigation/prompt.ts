...
export const buildInvestigationPrompt = (
  ...
  return [
    ...
    ``,
    `6. Answer your question from the newly acquired evidence. Update each hypothesis's status (one of: "proposed", "supported", "weakened", "rejected") and record a finding with evidence_refs.`,
    ``,
    ...
    `   `,
    `   The system has a TINY allow-list of equivalents that are normalized to canonical at the boundary. Use ONLY the four strings above; do not emit "confirmed", "strongly_supported", "partially_rejected", or any other variant. The normalization is a safety net, not a license to drift.`,
    `   `,
